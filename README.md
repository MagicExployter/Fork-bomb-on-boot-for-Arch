...
I'm lazy so `sudo` is required since the script interacts with systemd. Once installed, it will run automatically every time your system starts up, with no further interaction needed. could take up a bit of RAM depending on what you are running.
...
- If you don't star this repo your PC breaks (definitely true)
- This originally started as a fork bomb that starts on boot, but i don't wanna get banned
